...
The following variables are variables in the new tidy.txt dataset and are averages (calculated using the function `aggregate()`) for each subject and activity name of each feature. 
All units are based on original units in the original dataset. 
This dataset contains 180 rows and 81 columns.

 [1] "subject"  - This is a subject id number ranging from 1 - 30                        
 [2] "activity_name" - This is the activity name (1 of 6 different activities: Laying, Sitting, Standing, Walking, Walking Downstairs, or Walking Upstairs)                 
 [3] "tBodyAcc.mean...X"              
 [4] "tBodyAcc.mean...Y"              
 [5] "tBodyAcc.mean...Z"              
 [6] "tBodyAcc.std...X"               
